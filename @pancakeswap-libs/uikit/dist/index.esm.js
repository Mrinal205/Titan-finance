...
var Icon$c = function (props) {
    ...
    var secondaryColor = theme.isDark ? "#EAE2FC" : "#bdc2c4";
...
var Icon$w = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/web-img/Preser.png" })));
};
...
var getThemeTextColor = function (_a) {
    ...
    return outline ? getColor$1(variant, theme) : "#00183c";
};
...
var Icon$O = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/web-img/Tread.png" })));
};
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/maximumfarm",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/MaximumFarm",
    },
];
var MENU_HEIGHT = 64;
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, target: "_blank", className: className },
            icon,
            React.createElement(LinkLabel, { isPushed: isPushed , target: "_blank"}, label),
            isOpen ? React.createElement(Icon$8, null) : React.createElement(Icon$7, null)),
        React.createElement(AccordionContent, { isOpen: isOpen, isPushed: isPushed, target: "_blank", maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT }, children)));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, target: "_blank", isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu, background: "#000" },
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
            ...
            style: { backgroundColor: "#e3ba3f",color: "#000", height: "35px", borderRadius: "10px",border: "2px solid #fff", margin: "20px", size: "sm" }, onClick: function () {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#353547", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#00183c", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#EAE2FC", textDisabled: "#BDC2C4", textSubtle: "#fff", borderColor: "#E9EAEB", card: "#00183c", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e3ba3f", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#00183c", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#fff", borderColor: "#524B63", card: "#00183c", gradients: {
