   ...
   <div className="backbg">
      ...
      <div>
        ...
        <StyledCakeStats style={{background: "rgb(50, 139, 109, 0.7)",borderRadius: "5px"}}>
            ...
            <h2 style={{textAlign: "left",fontSize:"25px",marginBottom:"30px"}}>MNSTR  - WFTM</h2>
              {/* <img src="images/egg/BTCB.png" alt="img" height="15%" width="15%"/> */}
              {/* <h2 style={{textAlign: "right",fontSize:"25px"}}>MNSTR</h2> */}
              <p style={{marginTop: "5px",marginBottom: "5px"}}><span className="but1a">50X</span><span className="but1abc" style={{color: "#fff"}}>No fees</span></p>
              <br/><br/>
              <Row>
          ...
          <StyledCakeStats style={{background: "rgb(50, 139, 109, 0.7)",borderRadius: "5px"}}>
            <CardBody className="twitterback">
            <h2 style={{textAlign: "left",fontSize:"25px",marginBottom:"30px"}}>MNSTR  - USDC</h2>
              {/* <img src="images/egg/DAI.png" alt="img" height="15%" width="15%"/> */}
              {/* <h2 style={{textAlign: "right",fontSize:"25px"}}>WBNB</h2> */}
              <p style={{marginTop: "5px",marginBottom: "5px"}}><span className="but1a">50X</span><span className="but1abc" style={{color: "#fff"}}>3%</span></p>
              <br/><br/>
              <Row>
                <Text fontSize="14px">APR:</Text>
                <Text bold>23323232%</Text>
          ...
          <StyledCakeStats style={{background: "rgb(50, 139, 109, 0.7)",borderRadius: "5px"}}>
            <CardBody className="twitterback">
            <h2 style={{textAlign: "left",fontSize:"25px",marginBottom:"30px"}}>FTM - USDC</h2>
              {/* <img src="images/egg/DAI.png" alt="img" height="15%" width="15%"/> */}
              {/* <h2 style={{textAlign: "right",fontSize:"25px"}}>CAKE</h2> */}
              <p style={{marginTop: "5px",marginBottom: "5px"}}><span className="but1a">7X</span><span className="but1abc" style={{color: "#fff"}}>3%</span></p>
              <br/><br/>
              <Row>
                <Text fontSize="14px">APR:</Text>
                <Text bold>23323232%</Text>
          ...
          <StyledCakeStats style={{background: "rgb(50, 139, 109, 0.7)",borderRadius: "5px"}}>
            <CardBody className="twitterback">
            <h2 style={{textAlign: "left",fontSize:"25px",marginBottom:"30px"}}>FTM - USDT</h2>
              {/* <img src="images/egg/DAI.png" alt="img" height="15%" width="15%"/> */}
          ...
          <StyledCakeStats style={{background: "rgb(50, 139, 109, 0.7)",borderRadius: "5px"}}>
            <CardBody className="twitterback">
            <h2 style={{textAlign: "left",fontSize:"25px",marginBottom:"30px"}}>USDC - USDT</h2>
              {/* <img src="images/egg/DAI.png" alt="img" height="15%" width="15%"/> */}
              {/* <h2 style={{textAlign: "right",fontSize:"25px"}}>BUSD</h2> */}
              <p style={{marginTop: "5px",marginBottom: "5px"}}><span className="but1a">5X</span><span className="but1abc" style={{color: "#fff"}}>3%</span></p>
              <br/><br/>
              <Row>
                <Text fontSize="14px">APR:</Text>
                <Text bold>23323232%</Text>
          ...
          <StyledCakeStats style={{background: "rgb(50, 139, 109, 0.7)",borderRadius: "5px"}}>
            <CardBody className="twitterback">
            <h2 style={{textAlign: "left",fontSize:"25px",marginBottom:"30px"}}>FTM - DAI</h2>
              {/* <img src="images/egg/DAI.png" alt="img" height="15%" width="15%"/> */}
